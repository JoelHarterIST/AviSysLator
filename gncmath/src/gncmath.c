...
// 	quat_t _ans;
// 	_ans.s =  cos(e.x / 2.0)*cos(e.y / 2.0)*cos(e.z / 2.0) + sin(e.x / 2.0)*sin(e.y / 2.0)*sin(e.z / 2.0);
// 	_ans.x =  cos(e.x / 2.0)*cos(e.y / 2.0)*sin(e.z / 2.0) - sin(e.x / 2.0)*sin(e.y / 2.0)*cos(e.z / 2.0);
// 	_ans.y =  cos(e.x / 2.0)*sin(e.y / 2.0)*cos(e.z / 2.0) + sin(e.x / 2.0)*cos(e.y / 2.0)*sin(e.z / 2.0);
// 	_ans.z =  sin(e.x / 2.0)*cos(e.y / 2.0)*cos(e.z / 2.0) - cos(e.x / 2.0)*sin(e.y / 2.0)*sin(e.z / 2.0);
...
// 	_ans.x = atan2(2.0*(q.s*q.z + q.x*q.y), 1 - 2.0*(q.x*q.x + q.y*q.y));
// 	_ans.y = asin(2.0*(q.s*q.x - q.y*q.z));
// 	_ans.z = atan2(2.0*(q.s*q.y + q.x*q.z), 1 - 2.0*(q.y*q.y + q.z*q.z));
...
// quat_t update_q(quat_t q, vec3_t w) {
// 	quat_t _ans;
// 	_ans.s = 0.5*( q.z*w.x - q.y*w.y + q.x*w.z);
// 	_ans.x = 0.5*( q.y*w.x + q.z*w.y - q.s*w.z);
// 	_ans.x = 0.5*(-q.x*w.x + q.s*w.y + q.z*w.z);
// 	_ans.x = 0.5*(-q.s*w.x - q.x*w.y - q.y*w.z);
